...
public class WXLayouUserAdapter extends RecyclerView.Adapter<WXLayouUserAdapter.MyViewHolder> {

    private Context context;
    private List<Map<String, Object>> data;

    public WXLayouUserAdapter(Context context, List<Map<String, Object>> data) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.wxlayout_user_item, parent, false);
